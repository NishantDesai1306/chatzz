...
var actualUserModelName = null;
var chatUserModel = null;

var STATUS_ONLINE = 'online';
var STATUS_OFFLINE = 'offline';
var noop = function(userId) {
    var defer = Q.defer();
    var user = { user: userId };

    chatUserModel.populate(user, 'user', function(err, populatedObj) {
        return defer.resolve(populatedObj.user);
    });
...
exports.initModel = function(modelName, userModelName) {
    if (!chatUserModel) {
        ...
        actualUserModelName = userModelName = userModelName || DEFAULT_USER_MODEL_NAME;
