...
var getChatzzConfig = require('../../').getChatzzConfig;
...
var DEFAULT_FIELDS_TO_POPULATE = '-password -salt';
        ...
        ChatUserSchema.statics = {
            ...
            getChatUser: function(user) {
                ...
                model.findOne({
                    ...
                    .populate('user', getChatzzConfig().userFieldsToPopulate || DEFAULT_FIELDS_TO_POPULATE)
